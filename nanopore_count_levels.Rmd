...
These have been produced from the Kraken Report files using a perl script [scripts/read_counts.pl](attached)
...
Read in [tables/nanopore_counts.txt](nanopore_counts.txt) and make a bar-chart. The first numeric column is unmapped reads, the remaining columns decay from the total number of mapped reads.
